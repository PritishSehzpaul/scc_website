...
# TODO: it is not writing to app.log. Debug that
...
class AppLogger:
    ...
    def __init__(self, logger_name, logger_level):
        ...
        f_handler = logging.FileHandler(AppLogger.log_file, mode='a', encoding='utf-8')
        ...
        logging.getLogger('flask.app').addHandler(f_handler)
